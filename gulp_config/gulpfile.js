...
gulp.task('build', function(callback) {
    Plugins.sequence(['clean-css', 'clean-images', 'clean-js', 'clean-html'], ['concatcss-general','concatscss-safe','concatcss-index'], ['taskCss', 'taskImages', 'taskJs'], 'taskHtml', callback);
});
...
gulp.task('default', ['browser-sync'], function() {
    gulp.watch($CFG.watch.styles, ['taskCss','concatcss-general','concatscss-safe','concatcss-index']);
